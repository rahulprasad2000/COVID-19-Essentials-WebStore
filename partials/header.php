				...
				<nav class="limiter-menu-desktop container">
						  <div class="container-fluid">
						    <a class="navbar-brand" href="index.php">
						      <img src="images/icons/masky.png" alt="" width="50" height="50" class="d-inline-block align-text-centre">
						       <span style="color: black;">Covid Essentials</span>
						    </a>
						  </div>
						
					<!-- Logo desktop -->		
					<!-- <a href="#" class="logo" >
						<img src="images/icons/Covid Essentails.png" alt="IMG-LOGO">
