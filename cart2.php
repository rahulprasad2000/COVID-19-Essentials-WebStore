					...
					<div class="m-l-25 m-r--38 m-lr-0-xl">
						<div class="wrap-table-shopping-cart">
							<table class="table-shopping-cart">
								...
								<?php
									 ...
									 $customer_id="ORDS" . rand(10000,99999999);
								...
								<tr class="table_row">
									...
									<td class="column-5">Rs. <?php echo $value['item_price'] ?></td>
								<!-- </form> -->
								</tr>
								<?php }
						...
						<div class="flex-w flex-sb-m bor15 p-t-18 p-b-15 p-lr-40 p-lr-15-sm">
							...
							<!-- <div class="flex-c-m stext-101 cl2 size-119 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-10">
								<button class="btn btn-sm btn-outline-danger" name="quantity">Update Cart</button>
							</div> -->
							...
							<div class="size-209 p-t-1">
                             ...
                             <input type="hidden" id="ORDER_ID" tabindex="1" maxlength="20" size="20"
                               ...
                               <input type="hidden" title="TXN_AMOUNT" tabindex="10"
								type="text" name="TXN_AMOUNT" value="<?php echo $total ?>">
