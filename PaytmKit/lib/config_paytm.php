...
define('PAYTM_MERCHANT_KEY', 'yme0h7sqd&7TQZCK'); //Change this constant's value with Merchant key received from Paytm.
define('PAYTM_MERCHANT_MID', 'JNbtWV78121159201476'); //Change this constant's value with MID (Merchant ID) received from Paytm. 
